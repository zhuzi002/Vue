var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        jQuery('#sample_1 thead tr').each( function () {
            this.insertBefore( nCloneTh, this.childNodes[0] );
        } );

        jQuery('#sample_1 tbody tr').each( function () {
         ...
         */
        jQuery('#sample_1').on('click', ' tbody td .row-details', function () {
     ...
     var initTable2 = function() {
        var oTable = jQuery('#sample_2').dataTable( {
            "aoColumnDefs": [
                { "aTargets": [ 0 ] }
            ],
            "aaSorting": [[1, 'asc']],
